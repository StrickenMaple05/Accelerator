...
#include "../../Accelerator/Accelerator/autorization.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Autorization_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 31, 23)
    ...
    "Autorization\0on_enter_clicked\0\0"
    "on_registration_clicked\0"
};
...
void Autorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Autorization *_t = static_cast<Autorization *>(_o);
        switch (_id) {
...
const QMetaObject Autorization::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Autorization.data,
      qt_meta_data_Autorization,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Autorization.stringdata))
        return static_cast<void*>(const_cast< Autorization*>(this));
